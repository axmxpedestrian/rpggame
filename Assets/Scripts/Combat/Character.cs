...
namespace CombatSystem
{
    ...
    public class Character : MonoBehaviour, ICharacter
    {
        ...
        [Header("武器熟练度")]
        [SerializeField] private WeaponProficiencySystem weaponProficiency = new();
        [SerializeField] private WeaponProficiencyConfig proficiencyConfig;
        
        public WeaponProficiencySystem WeaponProficiency => weaponProficiency;
        
        [Header("技能")]
        [SerializeField] private CharacterSkillManager skillManager = new();
        ...
        private void Awake()
        {
            ...
            // 初始化武器熟练度
            if (proficiencyConfig != null)
                weaponProficiency.InitializeFromConfig(proficiencyConfig);
            else
                weaponProficiency.Initialize();
        }
        ...
        /// 复活（ICharacter接口实现）
        /// </summary>
        void ICharacter.Revive(int healthAmount)
        {
            Revive(healthAmount, 0f);
        }
